                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-content">
                                <div class="file-manager">
                                    ...
                                    <a href="javascript:;" onclick="findByState(-1)" class="file-control" id="file-control_All">
                                        <i class="fa fa-th"> 所有</i>
                                    </a>
                                    <a href="javascript:;" onclick="findByState(0)" class="file-control" id="file-control_0">
                                        <i class="fa fa-paperclip"> 草稿</i>
                                    </a>
                                    <a href="javascript:;" onclick="findByState(1)" class="file-control" id="file-control_1">
                                        <i class="fa fa-link"> 已发布</i>
                                    </a>
                                    <a href="javascript:;" onclick="findByState(2)" class="file-control" id="file-control_2">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="pull-right">
                                            <a class="btn btn-warning btn-xs temp"><i class="fa fa-pencil"></i> 添加分类</a>
                                        </div>
                                    </div>
                                    <ul class="folder-list" style="padding: 0">
                                        ...
                                        <c:forEach items="${categoryList}" var="categ">
                                            <li>
                                                <a href="javascript:;" onclick="findByCategory('${categ.categoryid}')">
                    ...
                    <div class="col-sm-9">
                        <div class="row">
                            <div class="col-sm-12" style="padding-left: 0px">
                                ...
                                <%--表格数据--%>
                                <c:if test="${!empty articleList}">
                                    <table class="footable table table-bordered" style="background: #fff"
                                           data-paging="false">
                                        <thead>
                                        <tr>
                                        ...
                                        <c:forEach items="${articleList}" var="article">
                                            <tr>
                                                ...
                                                <td style="text-align:center;vertical-align:middle">
                                                    <a href="javascript:;" onclick="findByCategory(${article.category.categoryid})">
