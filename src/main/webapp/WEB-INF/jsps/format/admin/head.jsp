                ...
                <section class="vbox">
                            ...
                            <nav class="nav-primary hidden-xs">
                                ...
                                <ul class="nav">
                                    ...
                                    <li class="active">
                                        ...
                                        <a href="javascript:;" class="active" id="indexPage">
                                    ...
                                    <li>
                                        ...
                                        <ul class="nav lt">
                                            <li>
                                                <a href="javascript:;" id="articleManege"> <i class="fa fa-angle-right"></i> <span>文管管理</span> </a>
                                            </li>
                                            <li>
                    ...
                    <footer class="footer lt hidden-xs b-t b-dark">
                        ...
                        <div class="btn-group pull-right">
                            <a href="#nav" title="全屏化" class="btn btn-sm btn-dark btn-icon hidden-nav-xs"
