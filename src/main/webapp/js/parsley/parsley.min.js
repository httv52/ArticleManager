...
!function(d){var h=function(a){this.messages={defaultMessage:"该数据是无效的。",type:{email:"该数据不满足邮件格式。",url:"该数据不满足url格式。",urlstrict:"该数据不满足url格式。",number:"该数据应该为数字。",digits:"该数据应该为数字。",dateIso:"改数据日期格式应该为 (YYYY-MM-DD).",alphanum:"该数据应改为字母。",phone:"这数据应该是有效的电话号码。"},notnull:"该数据不能为空。",
notblank:"改数据不能为空白。",required:"该数据为必需项",regexp:"这数据是无效的。",min:"该数据应该大于或等于 %s。",max:"该数据应该小于或等于 %s。",range:"该数据应该在 %s 到 %s之间。",minlength:"该数据过短，至少需要 %s 个字符。",maxlength:"该数据过长，最多需要 %s 个字符。",rangelength:"该数据长度无效，应在 %s 到 %s 之间。",
mincheck:"该数据至少需要选择 %s 项。",maxcheck:"该数据最多需要选择 %s 项。",rangecheck:"该数据选项应该在 %s 到 %s 之间。",equalto:"该值应该相同。"};this.init(a)};h.prototype={constructor:h,validators:{notnull:function(a){return 0<a.length},notblank:function(a){return"string"===typeof a&&""!==a.replace(/^\s+/g,"").replace(/\s+$/g,"")},required:function(a){if("object"===typeof a){for(var b in a)if(this.required(a[b]))return!0;return!1}return this.notnull(a)&&
